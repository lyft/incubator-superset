...
import GeoAnnotationLayer from './GeoAnnotationLayer';
...
class GeoAnnotationLayerControl extends React.PureComponent {
  constructor(props) {
    super(props);
    this.addGeoAnnotationLayer = this.addGeoAnnotationLayer.bind(this);
    this.removeGeoAnnotationLayer = this.removeGeoAnnotationLayer.bind(this);
  }
  ...
  addGeoAnnotationLayer(annotationLayer) {
  ...
  removeGeoAnnotationLayer(annotation) {
    ...
    return (
      ...
      >
        <GeoAnnotationLayer
          ...
          addGeoAnnotationLayer={this.addGeoAnnotationLayer}
          removeGeoAnnotationLayer={this.removeGeoAnnotationLayer}
...
GeoAnnotationLayerControl.propTypes = propTypes;
GeoAnnotationLayerControl.defaultProps = defaultProps;
...
export default connect(mapStateToProps, mapDispatchToProps)(GeoAnnotationLayerControl);
