...
const propTypes = {
  ...
  addGeoAnnotationLayer: PropTypes.func,
  removeGeoAnnotationLayer: PropTypes.func,
...
const defaultProps = {
  ...
  addGeoAnnotationLayer: () => {},
  removeGeoAnnotationLayer: () => {},
  close: () => {},
};

export default class GeoAnnotationLayer extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  deleteAnnotation() {
    this.props.close();
    if (!this.state.isNew) {
      this.props.removeGeoAnnotationLayer(this.state);
    }
  }
  ...
  applyAnnotation() {
    if (this.state.name.length) {
      ...
      this.props.addGeoAnnotationLayer(annotation);
...
GeoAnnotationLayer.propTypes = propTypes;
GeoAnnotationLayer.defaultProps = defaultProps;
